/*!
 * knowall can be used for identifying mysterious text
 ...
 * ```toml
 * [dependencies]
 * knowall = { version = "0.7", default-features = false }
 * ```
 *
 ...
 * ```toml
 * [dependencies]
 * knowall = { git = "https://github.com/swanandx/knowall", default-features = false }
 * ```
 *
 * # Example:
 *
